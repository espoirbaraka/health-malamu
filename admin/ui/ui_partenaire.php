                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                      ...
                      bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            ...
                            <th class="px-4 py-3">Site web</th>
                    ...
                    dark:bg-gray-800">
                        ...
                        $partenaire = $app->fetchPrepared($sql);
                        foreach ($partenaire as $row) {
                        ?>
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3 text-sm">
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        <img class="object-cover w-full h-full rounded-full" src="fichier/<?php echo $row['Avatar']; ?>" alt="" loading="lazy" />
                                        <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <?php echo $row['NomPartenaire'] ?>
                                </td>
                                <td class="px-4 py-3 text-sm">
